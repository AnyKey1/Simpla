...
<SCRIPT src="design/{$settings->theme}/js/tabs.js" language="JavaScript"type="text/javascript"></SCRIPT>
<!-- Хлебные крошки #End /-->
...
<!-- Р’С‹Р±РѕСЂ РІР°СЂРёР°РЅС‚Р° С‚РѕРІР°СЂР° -->

		<form class="variants" action="/cart">
			<table>
                        {if $smarty.get.variant}
                        {foreach $product->variants as $v}
                        {if $smarty.get.variant == $v->id}
                        <tr class="variant">
				<td>
					<input id="related_{$v->id}" name="variant" value="{$v->id}" type="radio" class="variant_radiobutton"  checked style="display:none;"/>
				</td>
				<td>
			...
			<input type="submit" class="button" value="в корзину" data-result-text="в корзину"/>
		</form>
		<!-- Р’С‹Р±РѕСЂ РІР°СЂРёР°РЅС‚Р° С‚РѕРІР°СЂР° (The End) -->
	<!-- Описание товара -->
